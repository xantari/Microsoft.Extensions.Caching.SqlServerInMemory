...
namespace Microsoft.Extensions.Caching.SqlServerInMemory
{
    ...
    /// </summary>
    public class SqlServerCacheInMemory : IDistributedCache
    {
        ...
        public SqlServerCacheInMemory(IOptions<SqlServerCacheOptions> options)
        {
        ...
        {
            var utcNow = _systemClock.UtcNow.UtcDateTime;
