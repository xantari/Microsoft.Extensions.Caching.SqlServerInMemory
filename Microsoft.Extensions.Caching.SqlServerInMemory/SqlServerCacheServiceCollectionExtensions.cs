...
using Microsoft.Extensions.Caching.SqlServerInMemory;
...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class SqlServerCachingServicesExtensions
    {
        ...
        public static IServiceCollection AddDistributedSqlServerInMemoryCache(this IServiceCollection services, Action<SqlServerCacheOptions> setupAction)
        {
            if (services == null)
            {
        ...
        {
            services.Add(ServiceDescriptor.Singleton<IDistributedCache, SqlServerCacheInMemory>());
        }
    }
}